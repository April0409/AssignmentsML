...
def get_best_min_support_from_L1(data_set, C1):
    item_count = {}
    for t in data_set:
      for item in C1:
          if item.issubset(t):
...
def create_Ck(Lksub1, k):
    ...
    for i in range(len_Lksub1):
        ...
        for j in range(i+1, len_Lksub1):
            ...
            print("l2[0:",k-2,"]:",l2[0:k-2])
            l2.sort()
            print("l2:", l2)
            print("lenli",len(Lksub1),len(l1),len(l2))
...
def generate_L(data_set, k, min_support):
    ...
    suitable_min_support = get_best_min_support_from_L1(data_set, C1)
...
if __name__ == "__main__":
    ...
    L, support_data = generate_L(data_set, k=9, min_support=0.2)
